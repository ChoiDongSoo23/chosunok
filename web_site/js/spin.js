...
$.fn.spin = function(opts) {
	if (opts == null) opts = defaultSpinnerOpts;
	if (opts == "modal") opts = modalSpinnerOpts;
	...
	this.each(function() {
		...
		if (data.spinner) {
			data.spinner.stop();
			delete data.spinner;
			if (opts == modalSpinnerOpts) $("#spin_modal_overlay").remove();
			return this;
		}
		
		var spinElem = this;
		if (opts == modalSpinnerOpts){
