...
function smoothScroll(content, viewport, smoothness) {
    ...
    gsap.set(viewport || content.parentNode, {overflow: "hidden",  width: "100%", top: 0, left: 0, right: 0, bottom: 0});
        ...
        ScrollTrigger.create({
            onUpdate: function (self) {
                if ( bookDatePickerEl ) {
                    ...
                    outTimeline.to(bookDatePickerContEl, {
                        duration: 0.7, y: '245px', ease: Power3.out,
                    });
                    currentTimeline = outTimeline;
                }
                // -1 = down 1 = up
                if (self.direction === 1) {   // down
                    if (scrollDirection === false) {
                        ...
                        if ( navBarEl && !toTopClick ) {
                            ...
                            if ( bookDatePickerEl ) gsap.to(bookDatePickerEl, {duration: 0.3, bottom: 20, ease: Power3.out});
                    ...
                    if (scrollDirection === true && !toTopClick) {
                        ...
                        if ( navBarEl ) {
                            ...
                            if ( bookDatePickerEl ) gsap.to(bookDatePickerEl, {duration: 0.3, bottom: 20+navBarH, ease: Power3.out});
